              ...
              <div className="flex flex-col lg:flex-row-reverse justify-center items-center gap-10">
                ...
                <div>
                  ...
                  <p className="dark:text-white text-slate-700">
                    ...
                    organization. We're a community united by a love for sports
                    and a commitment to nurturing the talents and aspirations of
                  ...
                  <div className="dark:text-white text-slate-700">
                    ...
                    <ul className="list-disc ps-6">
                      <li>
                        ...
                        potential. We offer coaching in a wide range of sports,
                        from soccer and basketball to swimming and athletics.
                      </li>
                      <li>
                        <span className="font-semibold">
