          ...
          <div className="navbar-end">
            <div className="flex justify-center relative w-fit items-center rounded-full">
              ...
              <div className='absolute inset-0 z-0 flex dark:justify-end justify-start'>
                <motion.span layout transition={{ type:"spring", damping: 15, stiffness: 250}} className="h-full w-1/2 rounded-full bg-gradient-to-r from-red-500 to-yellow-500">
                </motion.span>
              </div>
            </div>
          </div>
          <span className='absolute bg-gradient-to-r from-red-500 via-yellow-500 to-transparent h-1 w-full bottom-0' style={{transform:`translateX(${completion-100}%)`}}>
          </span>
        </div>
      </>
    );
